...
public class MainActivity extends AppCompatActivity {
    ...
    public void newMatch() {  //A game is composed of three matches
        ...
        if (correctButton==0)
        {
            ...
            button3.setText(correctanswer+9+"");
            button4.setText(correctanswer-4+"");
        }
        else if (correctButton==1)
        {
            button1.setText(correctanswer+"");
            button2.setText(correctanswer+2+"");
            button3.setText(correctanswer+5+"");
            button4.setText(correctanswer-3+"");
        }
        else if (correctButton==2)
        {
            button1.setText(correctanswer+"");
            button2.setText(correctanswer+7+"");
            button3.setText(correctanswer+1+"");
            button4.setText(correctanswer-6+"");
        }
        else
        {
            button1.setText(correctanswer+"");
            button2.setText(correctanswer+4+"");
            button3.setText(correctanswer+8+"");
            button4.setText(correctanswer-5+"");
        }
